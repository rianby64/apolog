 ...
 * TODO: Add documentation for this function
 */
export function feature(name, fn, thisArg) {
 ...
 * TODO: Add documentation for this function
 */
export function background(nameOrFn, fnOrThisArg, thisArgOrUndefined) {
  var name, fn, thisArg;
  if (nameOrFn) {
 ...
 * TODO: Add documentation for this function
 */
export function scenario(name, fn, thisArg) {
 ...
 * TODO: Add documentation for this function
 */
export function step(name, fn, thisArg) {
 ...
 * TODO: Add documentation for this function
 */
export function given(name, fn, thisArg) {
  return addDefinition(STEP, name, fn, thisArg);
}
 ...
 * TODO: Add documentation for this function
 */
export function when(name, fn, thisArg) {
  return addDefinition(STEP, name, fn, thisArg);
}
 ...
 * TODO: Add documentation for this function
 */
export function then(name, fn, thisArg) {
  return addDefinition(STEP, name, fn, thisArg);
}
 ...
 * TODO: Add documentation for this function
 */
export function and(name, fn, thisArg) {
  return addDefinition(STEP, name, fn, thisArg);
}
 ...
 * TODO: Add documentation for this function
 */
export function but(name, fn, thisArg) {
  return addDefinition(STEP, name, fn, thisArg);
}
