...
describe("Custom nested execution with", function() {
  ...
  it("steps not found", function() {
    ...
    expect(errors[8].message).toBe('Step not found "A given"');
    expect(errors[9].message).toBe('Step not found "A when"');
    expect(errors[10].message).toBe('Step not found "An and"');
    expect(errors[11].message).toBe('Step not found "A step"');
    expect(errors[12].message).toBe('Step not found "A given"');
